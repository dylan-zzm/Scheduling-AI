...
export async function getSettingGroups() {
  ...
  const settingGroups: SettingGroup[] = [
    ...
    },
    {
      name: 'evolink',
      title: 'EvoLink',
      description: `Custom <a href="https://docs.evolink.ai" class="text-primary" target="_blank">EvoLink</a> settings`,
      tab: 'ai',
    },
    {
      name: 'replicate',
...
export async function getSettings() {
  ...
  "premium-yearly": "prod_xxx"
    ...
    },
    {
      ...
      group: 'evolink',
      tab: 'ai',
      tip: 'Save EvoLink generated images to your own storage to avoid 24-hour expiry',
    },
    {
